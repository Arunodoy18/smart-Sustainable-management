...
class WasteClassificationAgent(
    BaseAgent[WasteClassificationInput, WasteClassificationOutput]
):
    def __init__(self):
        ...
        self.scenarios = {
            ...
            "organic": {
                ...
                "instructions": [
                    ...
                    "Place in green organic bin",
                    "Ensure no non-biodegradables are mixed",
                ],
            ...
            "hazardous": {
                ...
                "instructions": [
                    "Seal in a separate bag",
                    "Label clearly as hazardous",
